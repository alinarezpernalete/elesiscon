            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Notas de entrega por fecha</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col"> 
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Notas de entrega por usuario</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Notas de entrega por cliente</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Notas de entrega cancelados</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col"> 
    ...
    $(document).ready(function () {
        ...
        $("#byDate").click(function(e){
            if ($("#sinceByDate").val() == "" || $("#untilByDate").val() == "") {
                ...
                $('#byDate').attr('href', "/delNoteReport/byDate?since="+$("#sinceByDate").val()+"&until="+$("#untilByDate").val());
            }
        });
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#byUser").click(function(e){
            if ($("#user").val() == null || $("#sinceByUser").val() == "" || $("#untilByUser").val() == "") {
                ...
                $('#byUser').attr('href', "/delNoteReport/byUser?user="+$("#user").val()+"&since="+$("#sinceByUser").val()+"&until="+$("#untilByUser").val());
            }
        });
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#byCustomer").click(function(e){
            if ($("#customer").val() == null || $("#sinceByCustomer").val() == "" || $("#untilByCustomer").val() == "") {
                ...
                $('#byCustomer').attr('href', "/delNoteReport/byCustomer?customer="+$("#customer").val()+"&since="+$("#sinceByCustomer").val()+"&until="+$("#untilByCustomer").val());
            }
        });
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#byCancel").click(function(e){
            if ($("#sinceByCancel").val() == "" || $("#untilByCancel").val() == "") {
                ...
                $('#byCancel').attr('href', "/delNoteReport/byCancel?typeSale=5&since="+$("#sinceByCancel").val()+"&until="+$("#untilByCancel").val());
            }
        });
    });
</script>
