            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Facturas de venta por fecha</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col"> 
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Facturas de venta por usuario</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Facturas de venta por cliente</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Facturas de venta cancelados</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col"> 
    ...
    $(document).ready(function () {
        ...
        $("#byDate").click(function(e){
            if ($("#sinceByDate").val() == "" || $("#untilByDate").val() == "") {
                ...
                $('#byDate').attr('href', "/billReport/byDate?since="+$("#sinceByDate").val()+"&until="+$("#untilByDate").val());
            }
        });
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#byUser").click(function(e){
            if ($("#user").val() == null || $("#sinceByUser").val() == "" || $("#untilByUser").val() == "") {
                ...
                $('#byUser').attr('href', "/billReport/byUser?user="+$("#user").val()+"&since="+$("#sinceByUser").val()+"&until="+$("#untilByUser").val());
            }
        });
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#byCustomer").click(function(e){
            if ($("#customer").val() == null || $("#sinceByCustomer").val() == "" || $("#untilByCustomer").val() == "") {
                ...
                $('#byCustomer').attr('href', "/billReport/byCustomer?customer="+$("#customer").val()+"&since="+$("#sinceByCustomer").val()+"&until="+$("#untilByCustomer").val());
            }
        });
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#byCancel").click(function(e){
            if ($("#sinceByCancel").val() == "" || $("#untilByCancel").val() == "") {
                ...
                $('#byCancel').attr('href', "/billReport/byCancel?typeSale=5&since="+$("#sinceByCancel").val()+"&until="+$("#untilByCancel").val());
            }
        });
    });
</script>
