            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Facturas de compra por fecha</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col"> 
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Facturas de compra por usuario</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Facturas de compra por proveedor</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Facturas de compra canceladas</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col"> 
    ...
    $(document).ready(function () {
        ...
        $("#byDate").click(function(e){
            if ($("#sinceByDate").val() == "" || $("#untilByDate").val() == "") {
                ...
                $('#byDate').attr('href', "/invoiceReport/byDate?since="+$("#sinceByDate").val()+"&until="+$("#untilByDate").val());
            }
        });
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#byUser").click(function(e){
            if ($("#user").val() == null || $("#sinceByUser").val() == "" || $("#untilByUser").val() == "") {
                ...
                $('#byUser').attr('href', "/invoiceReport/byUser?user="+$("#user").val()+"&since="+$("#sinceByUser").val()+"&until="+$("#untilByUser").val());
            }
        });
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#byProvider").click(function(e){
            if ($("#provider").val() == null || $("#sinceByProvider").val() == "" || $("#untilByProvider").val() == "") {
                ...
                $('#byProvider').attr('href', "/invoiceReport/byProvider?provider="+$("#provider").val()+"&since="+$("#sinceByProvider").val()+"&until="+$("#untilByProvider").val());
            }
        });
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#byCancel").click(function(e){
            if ($("#sinceByCancel").val() == "" || $("#untilByCancel").val() == "") {
                ...
                $('#byCancel').attr('href', "/invoiceReport/byCancel?typePurchase=4&since="+$("#sinceByCancel").val()+"&until="+$("#untilByCancel").val());
            }
        });
    });
</script>
