            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Proveedores por fecha</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col"> 
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="font-weight-bold">Proveedores por status</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
    ...
    $(document).ready(function () {
        ...
        $("#byDate").click(function(e){
            if ($("#sinceByDate").val() == "" || $("#untilByDate").val() == "") {
                ...
                $('#byDate').attr('href', "/provReport/byDate?since="+$("#sinceByDate").val()+"&until="+$("#untilByDate").val());
            }
        });
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#byStatus").click(function(e){
            if ($("#status").val() == null) {
                ...
                $('#byStatus').attr('href', "/provReport/byStatus?status="+$("#status").val());
            }
        });
    });
</script>
